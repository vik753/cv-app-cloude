...
export function ResumePreview({ resume, t }: ResumePreviewProps) {
	return (
		...
		>
			<div className='print-toolbar mb-5 flex items-center justify-between'>
				<div>
					<span className='font-mono text-[11px] uppercase tracking-[.08em] text-[#537568]'>{t.preview}</span>
					<strong className='mt-1 block text-xs text-[#62736b]'>{t.page}</strong>
				</div>
				<span className='font-mono text-[11px] uppercase tracking-[.08em] text-[#829087]'>100%</span>
			</div>
			<article className='print-paper min-h-[690px] w-full bg-[#fbfaf5] p-7 text-[#263832] shadow-[0_12px_35px_rgba(50,65,55,.12)] sm:p-11'>
